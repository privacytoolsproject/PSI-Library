...
test_that('range checks throw correct warning', {
  ...
  expect_error(dpMean$new(mechanism='mechanismLaplace', variable='age', varType='numeric', n=my_n, epsilon=my_epsilon, rng=c(100)), 
  ...
  dp.mean <- dpMean$new(mechanism='mechanismLaplace', variable='age', varType='numeric', n=my_n, epsilon=my_epsilon, delta=my_delta, rng=c(0,100))
...
test_that('error thrown when n not positive or whole number', {
    my_epsilon <- 0.1
    my_delta <- 10^-6
    expect_error(dpMean$new(mechanism='mechanismLaplace', variable='age', varType='numeric', n=-1, epsilon=my_epsilon, rng=c(100)),
                 "n must be a positive whole number")
    expect_error(dpMean$new(mechanism='mechanismLaplace', variable='age', varType='numeric', n=0.5, epsilon=my_epsilon, rng=c(-10,0,100)),
                 "n must be a positive whole number")
})
...
test_that('range checks throw correct warning', {
    ...
    dp.mean <- dpMean$new(mechanism='mechanismLaplace', variable='sex', varType='logical', n=my_n, epsilon=my_epsilon, delta=my_delta)
    dp.mean$release(PUMS5extract10000)
...
test_that('getAccuracy and getEpsilon return approximately correct values for laplace mechanism', {
    ...
    dp.mean <- dpMean$new(mechanism='mechanismLaplace', variable='age', varType='numeric', n=my_n, epsilon=my_epsilon, rng=my_rng)
    dp.mean$release(PUMS5extract10000)
    ...
    dp.mean2 <- dpMean$new(mechanism='mechanismLaplace', variable='age', varType='numeric', n=my_n, accuracy=my_acc, rng=my_rng)
...
test_that('error messages when imputation range is outside of data range', {
    ...
    expect_warning(dpMean$new(mechanism='mechanismLaplace', variable='age', varType='numeric', n=my_n, epsilon=my_epsilon, rng=my_rng, imputeRng=c(0,93)),
    ...
    expect_warning(dpMean$new(mechanism='mechanismLaplace', variable='age', varType='numeric', n=my_n, epsilon=my_epsilon, rng=my_rng, imputeRng=c(18,200)),
    ...
    expect_warning(dpMean$new(mechanism='mechanismLaplace', variable='sex', varType='logical', n=my_n, epsilon=my_epsilon, imputeRng=c(2,3)),
                   'Imputation range entered for variable that is not of numeric or integer type. Setting imputation range to data range.')
    
    expect_warning(dpMean$new(mechanism='mechanismLaplace', variable='age', varType='numeric', n=my_n, epsilon=my_epsilon, rng=my_rng, imputeRng=c('wrong','type')),
    ...
    expect_error(dpMean$new(mechanism='mechanismLaplace', variable='age', varType='numeric', n=my_n, epsilon=my_epsilon),
