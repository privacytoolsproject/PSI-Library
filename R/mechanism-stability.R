...
mechanismStability$methods(
    ...
    #' "x" using the Stability mechanism. The Stability mechanism is meant to be used only with stable
    #' functions, which have a stronger guarantee on the output between neighboring databases. See 
    #' References for more information on stable functions. 
    #' 
