...
mechanismStability$methods(
    ...
    #' \eqn{\hat{x}}. For a histogram generated by the Stability mechanism, empty buckets will be removed and any
    ...
    #' 
    #' The accuracy threshold for removing bins with low counts is calculated by: \eqn{1+\frac{2*log(2/delta)}{epsilon}}.
    #' 
