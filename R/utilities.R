...
#' 
#' Note that this is necessary to preserve privacy: if a user enters an imputation range
#' that is outside of the data range then they may be able to determine something about
#' the presence of NA variables in the database based on the output of the statistic
#' 
#' @param imputationRange The imputation range entered by the user
#' @param rng The data range entered by the user
#' @param var.type The variable type for the data
#' 
