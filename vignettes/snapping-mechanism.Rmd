...
# release histogram on income
dp.histogram <- dpHistogram$new(mechanism = 'mechanismSnapping', varType = 'numeric',
                                variable = 'income', n=nrow(PUMS5extract10000), epsilon=0.1,
                                rng=c(0, 200000), nBins=10)
