...
# release variance on age
dp.variance <- dpVariance$new(mechanism = 'mechanismSnapping', varType='numeric', variable='age',
                        n=nrow(PUMS5extract10000), epsilon=0.1, rng=c(0,100))
