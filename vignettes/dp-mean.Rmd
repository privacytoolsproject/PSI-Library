...
x2 <- c(TRUE, FALSE, FALSE, TRUE, FALSE, TRUE, TRUE, TRUE, TRUE, TRUE)
data <- data.frame(x1, x2)

dp.mean <- dpMean$new(mechanism='mechanismLaplace', var.type='numeric', 
                      variable='x1', epsilon=1, n=10, rng=c(0, 70))
...
* `variable` \ Character, the name of the values in the data frame that will be passed to the mechanism. The name must match the name of a column of the dataframe that will be passed to the `release` method.
...
* `x` \ Data frame containing numeric, logical, or integer-value columns corresponding the names specified in `variable` and the variable type specified in `var-type`.
