...
dp.mean2 <- dpMean$new(mechanism='mechanismSnapping', var.type='numeric',
                      variable='income', epsilon=0.1, n=nrow(PUMS5extract10000), rng=c(0, 200000))
dp.mean2$release(PUMS5extract10000)

dp.mean3 <- dpMean$new(mechanism='mechanismLaplace', var.type='logical',
                       variable='sex', epsilon=0.1, n=nrow(PUMS5extract10000), rng=c(0, 1))
dp.mean3$release(PUMS5extract10000)

dp.mean4 <- dpMean$new(mechanism='mechanismSnapping', var.type='logical',
                       variable='sex', epsilon=0.1, n=nrow(PUMS5extract10000), rng=c(0, 1))
dp.mean4$release(PUMS5extract10000)
```
