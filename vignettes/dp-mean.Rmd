...
To calculate the mean of a logical variable, input a the name of a logical vector into `variable` and update `varType` to 'logical'. Note: you do not need to enter a range for a logical variable (because the values of a logical variable are known to be {0,1}).
