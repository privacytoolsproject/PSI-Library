...
In typical usage, there are two methods to the `dpCovariance` class: the `new` method and the `release` method. The `new` method creates an object of the class and accepts the following arguments:
