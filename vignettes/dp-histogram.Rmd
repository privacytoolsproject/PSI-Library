...
To calculate the histogram of a categorical (or 'character') variable instead, input a character vector into `variable` and update `var.type` to 'character'.
