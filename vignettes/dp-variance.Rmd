...
dpVarianceExample <- dpVariance$new(varType='numeric',
...
dpVarianceExample2 <- dpMean$new(varType='logical',
...
```{r}
numericVariance <- dpVariance$new(varType='numeric',
...
```{r}
logicalVariance <- dpVariance$new(varType='logical',
